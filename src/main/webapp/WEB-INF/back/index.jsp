			...
			{"menuid":"1","icon":"icon-sys","menuname":"内容管理",
				"menus":[ 
						...
						<shiro:hasPermission name="example:view"> 
				         {"menuname":"企业案例管理","url":"/admin/media/list.jhtml"},
				        </shiro:hasPermission>
						<shiro:hasPermission name="contact:view"> 
				         {"menuname":"用户咨询管理","url":"/admin/media/list.jhtml"},
				        </shiro:hasPermission>
						<shiro:hasPermission name="partners:view"> 
				         {"menuname":"合作伙伴管理","url":"/admin/media/list.jhtml"},
				        </shiro:hasPermission>
						<shiro:hasPermission name="companyMsg:view"> 
				         {"menuname":"企业信息管理","url":"/admin/media/list.jhtml"},
				        </shiro:hasPermission>
						<shiro:hasPermission name="team:view"> 
				         {"menuname":"核心团队管理","url":"/admin/media/list.jhtml"},
				        </shiro:hasPermission>
						<shiro:hasPermission name="banner:view"> 
				         {"menuname":"banner管理","url":"/admin/media/list.jhtml"},
				        </shiro:hasPermission>
						<shiro:hasPermission name="process:view"> 
				         {"menuname":"企业流程管理","url":"/admin/media/list.jhtml"},
				        </shiro:hasPermission>
						<shiro:hasPermission name="ourcustomer:view"> 
				         {"menuname":"企业客户管理","url":"/admin/media/list.jhtml"},
				        </shiro:hasPermission>
						<shiro:hasPermission name="contactus:view"> 
				         {"menuname":"关于我们管理","url":"/admin/media/list.jhtml"},
				        </shiro:hasPermission>
						<shiro:hasPermission name="addAdmin:view"> 
				         {"menuname":"添加管理员","url":"/admin/media/list.jhtml"},
				        </shiro:hasPermission>
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<noscript>
		<div
			...
			<img src="static/public/images/noscript.gif" alt='抱歉，请开启脚本支持！' />
		</div>
	</noscript>
